...
import { ArrowRight, ClipboardCheck, Snowflake, Sparkles, Wrench } from "lucide-react";
...
const icons = [Snowflake, Wrench, ClipboardCheck, Sparkles];
    ...
    <Section className="bg-secondary/40">
      <Container>
        <SectionHeading
          ...
          title="Installation, repair, maintenance and cleaning"
